...
style.setAttribute("href", "https://isbendev.github.io/isbendev/stylev3.css");
...
$('#lower').after("<div class='pin' id='pin'><div class='pinimg'><img class='post-thumbnail pinimg1' crossorigin='anonymous'/></div><div class='pinimg'><img class='post-thumbnail pinimg1' crossorigin='anonymous'/></div><div class='desc'><div class='desctxt'></div></div><div class='copyright'><div class='copyrighttxt'></div></div></div>");
...
function pageFullyLoaded(e) {
  ...
  onrendered: function(canvas) {
    $('.pin').html(Canvas2Image.convertToJPEG(canvas, 1000, 1500));
  }
  });
}
}else{
