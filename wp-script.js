...
document.getElementsByTagName("head")[1].appendChild(html2canvas); 
...
document.getElementsByTagName("head")[2].appendChild(canvas2image);
  
var style=document.createElement("link");
style.setAttribute("rel", "stylesheet");
style.setAttribute("type", "text/css");
style.setAttribute("href", "https://isbendev.github.io/isbendev/wp-style.css");
document.getElementsByTagName("head")[3].appendChild(style);
